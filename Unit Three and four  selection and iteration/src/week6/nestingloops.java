...
public class nestingloops {
   ...
   private static void wordFrame(String str) {
      ...
      System.out.print("*"); //for the star before the reversed string 
      for (int i = str.length() - 1; i >= 0; i--) { // to reverse and print the string 
         String letter = str.substring(i, i + 1);
         System.out.print(letter);
      }
      System.out.println("*"); // prints the star after the reverse string 
   }
